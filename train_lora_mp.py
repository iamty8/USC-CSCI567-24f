...
from train_lora import dino_vitb16
...
def get_parser():
    ...
    args.adapter_config = adapter_config
...
def main(args):
    ...
    backbone = dino_vitb16(pretrained=True, adapter_config=args.adapter_config)
...
def train(student, train_loader, optimizer, scaler, scheduler, cluster_criterion, epoch, args):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        # Train acc
        writer.add_scalar('Loss/loss_sum', loss.item(), epoch) # For visulization
...
if __name__ == '__main__':
    ...
    if dist.get_rank() == 0:
        init_experiment(args, runner_name=['lora_mp_test'])
